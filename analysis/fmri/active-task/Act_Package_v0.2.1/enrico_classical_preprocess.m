function enrico_classical_preprocess(F, S, path_to_spm8, tr, slice_order, refslice)
...
matlabbatch{bi}.spm.spatial.smooth.data(1).sname = 'Coregister: Estimate: Coregistered Images';
matlabbatch{bi}.spm.spatial.smooth.data(1).src_exbranch = substruct('.','val', '{}',{bi-2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{bi}.spm.spatial.smooth.data(1).src_output = substruct('.','cfiles');
